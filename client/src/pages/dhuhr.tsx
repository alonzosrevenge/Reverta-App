...
import { QiblaCompass } from "@/components/QiblaCompass"; // ⬅️ ADDED
...
const DHUHR_STEPS = [
  ...
  // Second Rakah
  {
    arabic:
      "Bismillāhi r-raḥmāni r-raḥīm. Al-ḥamdu lillāhi rabbi l-'ālamīn. Ar-raḥmāni r-raḥīm. Māliki yawmi d-dīn. Iyyāka na'budu wa iyyāka nasta'īn. Ihdinā ṣ-ṣirāṭa l-mustaqīm. Ṣirāṭa lladhīna an'amta 'alayhim ghayri l-maghḍūbi 'alayhim wa lā ḍ-ḍāllīn.",
    english: "Recite Al-Fātiḥa again for the second rak'ah.",
    description:
      "Stand up for the second rak'ah and recite Al-Fātiḥa again. This essential chapter is recited in every rak'ah.",
  ...
  },
  {
    ...
    english: "Allāhu Akbar",
    description:
      "Move into Rukū' for the second rak'ah. Place your hands on your knees and bow with the same humility.",
    step: "Rukū' (2nd Rakah)",
  },
  {
    arabic: "Subḥāna rabbiya l-'aẓīm",
    english: "Glory be to my Lord, the Most Great (3X)",
    description:
      "Glorify Allah while in Rukū'. Maintain the same reverence as the first rak'ah.",
  ...
  },
  {
    ...
    english:
      "Allah hears the one who praises Him. Our Lord, to You belongs all praise.",
    description:
      "Rise from Rukū' for the second time, maintaining the same posture and reverence.",
  ...
  },
  {
    ...
    english: "Glory be to my Lord, the Most High (3X)",
    description:
      "Prostrate for the first Sujūd of the second rak'ah. Maintain deep concentration.",
  ...
  },
  {
    ...
    english: "My Lord, forgive me",
    description:
      "Sit between prostrations and seek Allah's forgiveness with sincerity.",
  ...
  // Third Rakah
  {
    ...
    description:
      "Stand for the third rak'ah and recite Al-Fātiḥa. In the last two rak'ahs of Dhuhr, only Al-Fātiḥa is recited (no additional Surah).",
  ...
  // Fourth Rakah
  {
    ...
    description:
      "Stand for the fourth rak'ah and recite Al-Fātiḥa. This is the final rak'ah of Dhuhr prayer.",
  ...
  },
  {
    ...
    description:
      "Turn your head to the RIGHT and say: 'As-salāmu 'alaykum wa raḥmatullāh' (Peace and mercy of Allah be upon you). Then turn your head to the LEFT and repeat the same greeting. This completes your Dhuhr prayer.",
    step: "Tasleem (Final Salutations)",
  },
];

function DhuhrIntro({ onBegin }: { onBegin: () => void }) {
      ...
      <div className="text-center max-w-3xl mx-auto">
        <div className="mb-8 animate-scale-in">
          <div className="w-32 h-32 mx-auto rounded-3xl flex items-center justify-center shadow-2xl relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-yellow-400 via-orange-400 to-red-500 animate-pulse"></div>
            <div className="absolute inset-[2px] bg-slate-900 rounded-3xl flex items-center justify-center">
              <div
                className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-br from-yellow-400 to-orange-400"
        ...
        <div className="mb-8 animate-slide-up">
          ...
          <p className="text-xl md:text-2xl text-slate-300 font-light mb-2">
            Midday Prayer • 4 Rak'ahs
          </p>
          <p className="text-slate-400 text-sm md:text-base">
            The blessed midday prayer when the sun is at its zenith
          </p>
        </div>
        ...
        >
          ...
          {/* If your QiblaCompass doesn’t support `theme`, just remove the prop */}
        </div>
        ...
        >
          <button
            onClick={onBegin}
            className="group relative px-8 py-4 bg-gradient-to-r from-yellow-500 via-orange-500 to-red-500 rounded-2xl font-semibold text-slate-900 text-lg shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105"
          >
...
export default function DhuhrPage() {
  ...
  if (showIntro) {
    return <DhuhrIntro onBegin={() => setShowIntro(false)} />;
  }

  const current = DHUHR_STEPS[currentStep];
  const progress = ((currentStep + 1) / DHUHR_STEPS.length) * 100;

  const handleNext = () => {
    if (currentStep < DHUHR_STEPS.length - 1) {
  ...
  return (
    <div className="min-h-screen flex flex-col p-6 relative overflow-hidden">
      ...
      <div className="fixed top-0 left-0 w-full h-1 bg-slate-800/50 z-30">
        <div
          className="h-full bg-gradient-to-r from-yellow-400 via-orange-400 to-red-500 transition-all duration-500 ease-out"
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm">
              Step {currentStep + 1} of {DHUHR_STEPS.length}
            </p>
          </div>
        </div>
      </div>
                ...
                <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl">
                  <div className="relative w-full h-full flex items-center justify-center">
                    <img
                      ...
                      className="max-w-full max-h-full object-contain"
                      onLoad={() =>
                        console.log("Rising from Ruku image loaded")
                      }
                      onError={() =>
        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm rounded-3xl p-6 border border-slate-700/50">
              ...
              <div className="mb-6">
                <div className="bg-slate-700/50 rounded-xl p-4 inline-flex items-center gap-3">
                  {(current.step.includes("Opening Takbīr") || current.step.includes("Al-Fātiḥa") || current.step.includes("Additional Surah") || current.step.includes("Rukū'") || current.step.includes("Rising from Rukū'") || current.step.includes("Sujūd") || current.step.includes("Jalsa") || current.step.includes("Tashahhud") || current.step.includes("Salawat") || current.step.includes("Tasleem")) ? (
                    ...
                    <>
                      <button className="p-2 rounded-full bg-yellow-400/20 hover:bg-yellow-400/30 transition-colors opacity-50 cursor-not-allowed">
                        <Play className="w-5 h-5 text-yellow-400" />
                      </button>
            ...
            <div className="flex gap-4">
              ...
              <button
                onClick={handleNext}
                className="flex-1 px-6 py-3 bg-gradient-to-r from-yellow-500 via-orange-500 to-red-500 hover:from-yellow-400 hover:via-orange-400 hover:to-red-400 text-slate-900 font-semibold rounded-xl transition-all duration-300 hover:scale-105 shadow-lg"
              >
                {currentStep === DHUHR_STEPS.length - 1
                  ? "Complete Prayer"
                  : "Next Step"}
              </button>
            </div>
