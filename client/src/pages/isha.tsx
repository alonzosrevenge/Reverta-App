...
import { ArrowLeft, ArrowRight, Moon, Play, Pause } from "lucide-react";
...
const ISHA_STEPS = [
  ...
  // Second Rakah
  {
    ...
    description:
      "Stand for the second rak'ah and recite Al-Fātiḥa again. In the first two rak'ahs of Isha, both Al-Fātiḥa and an additional Surah are recited.",
  ...
  },
  {
    ...
    description:
      "Recite an additional Surah. Surah An-Nās offers protection from evil whispers and harmful influences.",
  ...
  // Third Rakah
  {
    ...
    description:
      "Stand for the third rak'ah and recite Al-Fātiḥa. In the last two rak'ahs of Isha, only Al-Fātiḥa is recited (no additional Surah).",
  ...
  // Fourth Rakah
  {
    ...
    description:
      "Stand for the fourth rak'ah and recite Al-Fātiḥa. This is the final rak'ah of Isha prayer.",
  ...
  },
  {
    ...
    description:
      "Turn your head to the RIGHT and say: 'As-salāmu 'alaykum wa raḥmatullāh' (Peace and mercy of Allah be upon you). Then turn your head to the LEFT and repeat the same greeting. This completes your Isha prayer.",
    step: "Tasleem (Final Salutations)",
  },
];

function IshaIntro({ onBegin }: { onBegin: () => void }) {
    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden animate-fade-in">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          ...
          style={{ top: "70%", left: "15%", animationDelay: "1s" }}
        ></div>
        <div
          className="absolute w-1 h-1 bg-blue-400 rounded-full animate-pulse"
          style={{ top: "60%", left: "85%", animationDelay: "1.5s" }}
        ></div>
        <div
          className="absolute w-1 h-1 bg-indigo-500 rounded-full animate-pulse"
      ...
      <div className="text-center max-w-3xl mx-auto">
        <div className="mb-8 animate-scale-in">
          <div className="w-32 h-32 mx-auto rounded-3xl flex items-center justify-center shadow-2xl relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-indigo-500 via-blue-600 to-purple-700 animate-pulse"></div>
            <div className="absolute inset-[2px] bg-slate-900 rounded-3xl flex items-center justify-center">
              <div
                className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-br from-indigo-400 to-blue-500"
        ...
        <div className="mb-8 animate-slide-up">
          ...
          <p className="text-xl md:text-2xl text-slate-300 font-light mb-2">
            Night Prayer • 4 Rak'ahs
          </p>
          <p className="text-slate-400 text-sm md:text-base">
            The blessed night prayer under the starlit sky
          </p>
        </div>
        ...
        >
          <button
            onClick={onBegin}
            className="group relative px-8 py-4 bg-gradient-to-r from-indigo-500 via-blue-600 to-purple-700 rounded-2xl font-semibold text-white text-lg shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105"
          >
...
export default function IshaPage() {
  ...
  if (showIntro) {
    return <IshaIntro onBegin={() => setShowIntro(false)} />;
  }

  const current = ISHA_STEPS[currentStep];
  const progress = ((currentStep + 1) / ISHA_STEPS.length) * 100;

  const handleNext = () => {
    if (currentStep < ISHA_STEPS.length - 1) {
  ...
  return (
    <div className="min-h-screen flex flex-col p-6 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        ></div>
        <div
          className="absolute w-1 h-1 bg-blue-300 rounded-full animate-pulse opacity-60"
          style={{ top: "25%", left: "90%", animationDelay: "0.5s" }}
        ></div>
        <div
          className="absolute w-1 h-1 bg-indigo-300 rounded-full animate-pulse opacity-60"
          style={{ top: "75%", left: "8%", animationDelay: "1s" }}
        ></div>
        <div
          className="absolute w-1 h-1 bg-blue-400 rounded-full animate-pulse opacity-60"
          style={{ top: "55%", left: "92%", animationDelay: "1.5s" }}
        ></div>
        <div
          className="absolute w-1 h-1 bg-indigo-500 rounded-full animate-pulse opacity-60"
          style={{ top: "45%", left: "12%", animationDelay: "2s" }}
        ></div>
        <div
          className="absolute w-1 h-1 bg-blue-500 rounded-full animate-pulse opacity-60"
          style={{ top: "85%", left: "88%", animationDelay: "2.5s" }}
        ></div>
        <div
          className="absolute w-1 h-1 bg-purple-400 rounded-full animate-pulse opacity-60"
          style={{ top: "15%", left: "50%", animationDelay: "3s" }}
        ></div>
        <div
          className="absolute w-1 h-1 bg-indigo-400 rounded-full animate-pulse opacity-60"
          style={{ top: "65%", left: "45%", animationDelay: "3.5s" }}
        ></div>
      </div>
      ...
      <div className="fixed top-0 left-0 w-full h-1 bg-slate-800/50 z-30">
        <div
          className="h-full bg-gradient-to-r from-indigo-500 via-blue-600 to-purple-700 transition-all duration-500 ease-out"
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm">
              Step {currentStep + 1} of {ISHA_STEPS.length}
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm rounded-3xl p-6 border border-slate-700/50">
                  ...
                  {(current.step.includes("Opening Takbīr") || current.step.includes("Al-Fātiḥa") || current.step.includes("Additional Surah") || current.step.includes("Rukū'") || current.step.includes("Rising from Rukū'") || current.step.includes("Sujūd") || current.step.includes("Jalsa") || current.step.includes("Tashahhud") || current.step.includes("Salawat") || current.step.includes("Tasleem")) ? (
                    <>
                      <button 
                        ...
                        className="p-2 rounded-full bg-indigo-400/20 hover:bg-indigo-400/30 transition-colors"
                      >
                        {isPlaying ? (
                    ...
                    <>
                      <button className="p-2 rounded-full bg-indigo-400/20 hover:bg-indigo-400/30 transition-colors opacity-50 cursor-not-allowed">
                        <Play className="w-5 h-5 text-indigo-400" />
                      </button>
            ...
            <div className="flex gap-4">
              ...
              <button
                onClick={handleNext}
                className="flex-1 px-6 py-3 bg-gradient-to-r from-indigo-500 via-blue-600 to-purple-700 hover:from-indigo-400 hover:via-blue-500 hover:to-purple-600 text-white font-semibold rounded-xl transition-all duration-300 hover:scale-105 shadow-lg"
              >
                {currentStep === ISHA_STEPS.length - 1
                  ? "Complete Prayer"
                  : "Next Step"}
              </button>
            </div>
